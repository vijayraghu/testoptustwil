...
def processRequest(req):
    ...
    #Transfer funds through account id
        ...
        result = createTransfer(accountnumber, accounttype, payeename, payeeaccounttype, payeeamount)
		...
		speech = 'I am sorry. We are experiencing some technical difficulty. Please call again later'
